const Styles = {
  ...
  details: {
    ...
    page: "pt-20 overflow-hidden shadow-2xl bg-white dark:bg-black bg-opacity-40 dark:bg-opacity-40 backdrop-filter backdrop-blur-xl z-30 absolute top-0 left-0 lg:left-[unset] w-screen h-screen lg:right-0 lg:w-[420px] lg:transition-all almostlg:transition-all ",
  },
};
